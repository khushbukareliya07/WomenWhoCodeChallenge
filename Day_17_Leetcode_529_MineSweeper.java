 ...
 * b. cunt mines = if greater than zero, dont explore babies, just assign count
 * to current position.
...
class Solution {
    ...
    public char[][] updateBoard(char[][] board, int[] click) {
        ...
        while (!q.isEmpty()) {
            ...
            // if we check visited here, than we'll not optimize ,beucase when we add
            // babies, we might be adding elemnts those are already in the Queue.
